...
class NonUniqueSnapshotVersionsReadOnlyCacheDependencyResolutionTest extends AbstractReadOnlyCacheDependencyResolutionTest {
    ...
    List<MavenHttpModule> getModulesInReadOnlyCache(MavenHttpRepository repo) {
        [
            snapshot = repo.module("org.module", "core", "1.0-SNAPSHOT").withNonUniqueSnapshots(),
        ]
    }
